    ...
    <div class="admin-manage">
        <div class="admin-manage-left">
            <ul>
                ...
                <li><a href="admin-workorder2.html" class="admin-left-a admin-manage-style-change">提升讲师级别<img src="../images/admin/三角形.png" alt="" ></a></li>
        ...
        <div class="admin-manage-right">
            <div class="admin-workorder-form3">
                    ...
                    <table>
                        <tr >   
                            ...
                            <td style="width: 128px;">
                                <label for="">姓名</label><span class="admin-workorder-form1-table-name">潘志文</span><br/>
                                <label for="">学历</label><span>本科</span>
                            </td>
                            <td style="width: 175px;">
                                <label for="">讲师级别</label><span>黑带大师</span><br/>
                            ...
                            <td style="width: 285px;">
                                <label for="">所属行业</label><span>杭州数控科技有限公司</span><br/>
                                <label for="">所在地区</label><span>杭州</span>
                            </td>
                ...
                <div class="admin-workorder-form1-table">
                    <table>
                        <tr >   
                            <td style="width: 114px;">
                                <img src="../images/admin/student/暂无认证.png" alt="">
